...
| 项目名称 | 项目简介 | 项目链接 |
|----------|-----------|:-----------:|
| WeChat-AI | WeChat AI - 自托管微信角色扮演对话服务 | [⭐ 1.8K](https://github.com/SMNETSTUDIO/WeChat-AI) |
| VoCat | Vocat is an open-source web control panel and engineering toolkit for Quectel EC20/EC25-class cellular modems. It...<br>Vocat 是一个开源网页控制面板和工程工具包，用于移远 EC20/EC25 系列蜂窝调制解调器。它... | [⭐ 474](https://github.com/MengMengCode/VoCat) |
| location-spoofer | 面向 iOS 定位服务行为研究和开发测试的虚拟定位工具，支持地图选点、本地与第三方代理、WGS-84 / GCJ-02 双坐标、环境检测和问题诊断。 | [⭐ 654](https://github.com/xweiba/location-spoofer) |
| outlookEmail | 暂无描述 | [⭐ 1.5K](https://github.com/assast/outlookEmail) |
| Vohive-155 | 暂无描述 | [⭐ 57](https://github.com/Orson-Yan/Vohive-155) |
...
| iCloud_Distributio<br>n | 暂无描述 | [⭐ 19](https://github.com/paipaiio/iCloud_Distribution) |
...
| singbox-deploy | 一个跨平台、自动化、全兼容的 Sing-box 一键部署脚本 | [⭐ 534](https://github.com/caigouzi121380/singbox-deploy) |
| device_faker | 自定义配置Zygisk机型伪装 | [⭐ 700](https://github.com/Seyud/device_faker) |
| TcpQuality | 暂无描述 | [⭐ 654](https://github.com/ibsgss/TcpQuality) |
| cf-outlook-email | 📬 基于 Cloudflare Workers 的轻量级 Outlook 邮件管理工具 · 免费 · 无需服务器 ｜ Lightweight Outlook email manager, serverless & free ⚡ | [⭐ 236](https://github.com/roseforyou/cf-outlook-email) |
| mjjssh | MJJ SSH 工具，ai助手管理面板 | [⭐ 7](https://github.com/34892002/mjjssh) |
| NetQuality | 网络质量检测脚本 - Network Quality Check Script | [⭐ 5.5K](https://github.com/xykt/NetQuality) |
...
| GPT5.6-5.5- | 此项目为gpt5.6/5.5破甲方案 | [⭐ 241](https://github.com/zxr-roro/GPT5.6-5.5-) |
| frp-openwrt-one-cl<br>ick | 一键安装 Frp，支持 VPS/云服务器和 OpenWrt/iStoreOS/软路由安装管理 frps/frpc | [⭐ 7](https://github.com/slobys/frp-openwrt-one-click) |
| rustdesk | An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer.<br>一款开源远程桌面应用程序，专为自托管设计，作为TeamViewer的替代方案。 | [⭐ 12.1W](https://github.com/rustdesk/rustdesk) |
...
| saladict | 🌈一个跨平台的划词翻译和OCR软件 ｜ A cross-platform software for text translation and recognition. | [⭐ 132](https://github.com/allentown521/saladict) |
...
| Codex-X | OpenAI Codex 桌面端/CLI 的可视化管理工具，具有Provider/API 切换、会话同步、提示词注入、Skills/MCP 管理、TOML 配置可视化的跨平台工具。 | [⭐ 2.7K](https://github.com/yynxxxxx/Codex-X) |
| CLIProxyAPI | Wrap Antigravity, ChatGPT Codex, Claude Code, Grok Build as an OpenAI/Gemini/Claude/Codex compatible API service,...<br>将 Antigravity、ChatGPT Codex、Claude Code、Grok Build 封装为与 OpenAI/Gemini/Claude/Codex 兼容的 API 服务，…… | [⭐ 4.8W](https://github.com/router-for-me/CLIProxyAPI) |
...
| nodewarden | Bitwarden-compatible server running on Cloudflare Workers<br>运行在Cloudflare Workers上的与Bitwarden兼容的服务器 | [⭐ 3.4K](https://github.com/shuaiplus/nodewarden) |
| dnsmgr | 彩虹聚合DNS管理系统 | [⭐ 1.4K](https://github.com/netcccyun/dnsmgr) |
| sub2api | Sub2API 一站式开源中转服务，让 Claude、Openai 、Gemini、Grok订阅统一接入，支持拼车共享，更高效分摊成本，原生工具无缝使用。 | [⭐ 3.8W](https://github.com/Wei-Shaw/sub2api) |
| dji-4g-vohive-mac | 在 Mac（Apple Silicon / Intel）上用 UTM 跑 Linux 虚拟机，把大疆 4G 模块（EG25-G）伪装成移远 Quectel EC25 并部署 vohive 平台的完整步骤 | [⭐ 970](https://github.com/wlzh/dji-4g-vohive-mac) |
...
| tg-vault | 暂无描述 | [⭐ 170](https://github.com/hicocos/tg-vault) |
| Netcatty | SSH workspace, SFTP, and terminals in one<br>SSH工作区、SFTP和终端三合一。 | [⭐ 5.3K](https://github.com/binaricat/Netcatty) |
| CF-Server-Monitor | 一个基于 Cloudflare Workers + D1 + Durable Objects 的免费多服务器监控探针系统，支持实时监控、离线告警，到期通知，历史数据查看、延迟追踪、地图展示等功能。兼容主流Linux系统，Alpine... | [⭐ 1.4K](https://github.com/huilang-me/CF-Server-Monitor) |
...
| codex-candy-eval | Codex 降智测试 | [⭐ 820](https://github.com/haowang02/codex-candy-eval) |
| cc-switch | A cross-platform desktop All-in-One assistant for Claude Code, Codex, OpenCode, OpenClaw, Grok Build & Hermes Agent....<br>一个跨平台桌面一体化助手，适用于Claude Code、Codex、OpenCode、OpenClaw、Grok Build和Hermes Agent等…… | [⭐ 12.9W](https://github.com/farion1231/cc-switch) |
| CodexPlusPlus | An enhanced tool for CodexApp, striving to make Codex better to use and more comfortable...<br>一款针对CodexApp的增强工具，致力于让Codex更好用、更舒适…… | [⭐ 2.9W](https://github.com/BigPizzaV3/CodexPlusPlus) |
| vohive-release | 暂无描述 | [⭐ 795](https://github.com/iniwex5/vohive-release) |
| dujiao-next | Dujiao-Next<br>独角-下一代 | [⭐ 1.0K](https://github.com/dujiao-next/dujiao-next) |
| daidai-panel | Lightweight scheduled task management panel, similar to Qinglong Panel. 轻量级定时任务管理面板 | [⭐ 416](https://github.com/linzixuanzz/daidai-panel) |
| carrier-ims-for-pi<br>xel | Carrier IMS for Pixel (TurboIMS): multilingual (中文/English) pixel ims / ims / carrierconfig / volte / vowifi / 5G+... | [⭐ 1.5K](https://github.com/ryfineZ/carrier-ims-for-pixel) |
| ds-free-api | DeepSeek网页端API代理，支持OpenAI与Anthropic兼容接口 ｜ OpenAI & Anthropic compatible API proxy for DeepSeek web | [⭐ 617](https://github.com/NIyueeE/ds-free-api) |
...
| read-frog | 🐸 Read Frog - Language Learning & Translate ｜ 🐸 陪读蛙 - 语言学习与翻译 | [⭐ 9.3K](https://github.com/mengxi-ream/read-frog) |
...
| sms-jiema | 汇总国外1000个免费手机号接码 - 国外免费手机号验证平台 | [⭐ 334](https://github.com/workwayfi/sms-jiema) |
| worldmonitor | Real-time global intelligence dashboard. AI-powered news aggregation, geopolitical monitoring, and infrastructure...<br>实时全球情报仪表盘。由人工智能驱动的新闻聚合、地缘政治监控及基础设施…… | [⭐ 8.3W](https://github.com/koala73/worldmonitor) |
| BilibiliSponsorBlo<br>ck | 一款跳过小电视视频中恰饭片段的浏览器插件，移植自 SponsorBlock。A browser extension to skip sponsored segments in videos, ported from the... | [⭐ 5.9K](https://github.com/hanydd/BilibiliSponsorBlock) |
...
| free-proxy-list | 🚀 Free HTTP, SOCKS4, & SOCKS5 proxy list * Updated every 5 minutes * and rotating proxy API (100+ countries)<br>🚀 免费HTTP、SOCKS4和SOCKS5代理列表 * 每5分钟更新一次 * 以及轮换代理API（覆盖100多个国家） | [⭐ 6.6K](https://github.com/proxifly/free-proxy-list) |
...
| oci-helper | 基于 Oracle OCI SDK 🐢 开发的 web 端可视化甲骨文云助手（Y探长），目前实现的功能有：批量添加多个租户配置、更改实例配置、引导卷配置、一键开启免费AMD实例下行500Mbps、一键更新、一键救援/缩小硬盘、附加ipv6、... | [⭐ 784](https://github.com/Yohann0617/oci-helper) |
...
| nav-item | 导航站 | [⭐ 392](https://github.com/eooce/nav-item) |
...
| nftables-nat-rust | nftables nat规则生成器 | [⭐ 955](https://github.com/arloor/nftables-nat-rust) |
...
| ChinaTextbook | 所有小初高、大学PDF教材。 | [⭐ 8.0W](https://github.com/TapXWorld/ChinaTextbook) |
...
| ContextMenuManager | 🖱️ 一个管理 Windows 右键上下文菜单的程序（支持Windows 7 - 11）A program to manage the Windows right-click context menu with support of... | [⭐ 887](https://github.com/Jack251970/ContextMenuManager) |
...
| komari-theme-purca<br>rte | 一个为 Komari 设计的磨砂玻璃风格主题 | [⭐ 427](https://github.com/Montia37/komari-theme-purcarte) |
| NodeQuality | 在沙箱环境中运行vps测试脚本，并排版测试结果 | [⭐ 2.0K](https://github.com/LloydAsp/NodeQuality) |
| subs-check | 订阅转换、测速、测活、流媒体检测、重命名、导出为任意格式订阅的工具 | [⭐ 5.2K](https://github.com/beck-8/subs-check) |
| zjm | 暂无描述 | [⭐ 43](https://github.com/vpsbuy/zjm) |
...
| komari | A simple server monitor tool.<br>一个简单的服务器监控工具。 | [⭐ 5.8K](https://github.com/komari-monitor/komari) |
...
| Duckfolio | 个人主页 | [⭐ 83](https://github.com/Yorlg/Duckfolio) |
...
| hexhub | Hexhub 是一款开源的SSH、SFTP、数据库管理客户端，数据库管理模块目前还在开发之中 | [⭐ 482](https://github.com/EdikKing/hexhub) |
...
| bilijump-ai | 一个使用 AI 自动跳过 Bilibili 视频植入广告的扩展程序。 | [⭐ 421](https://github.com/qingmeng1/bilijump-ai) |
...
| new-api | A unified AI model hub for aggregation & distribution. It supports cross-converting various LLMs into...<br>一个统一的人工智能模型中心，用于聚合与分发。它支持将各种大语言模型相互转换为…… | [⭐ 4.6W](https://github.com/QuantumNous/new-api) |
| mtg | Highly opinionated MTPROTO proxy for Telegram<br>高度个性化的Telegram MTProto代理 | [⭐ 3.7K](https://github.com/9seconds/mtg) |
| Yunzai | Yunzai 应用端，支持多账号，支持协议端：go-cqhttp、ComWeChat、GSUIDCore、ICQQ、QQBot、QQ频道、微信、KOOK、Telegram、Discord | [⭐ 620](https://github.com/TimeRainStarSky/Yunzai) |
| Yunzai-Bot-plugins<br>-index | Yunzai-Bot云崽QQ机器人插件索引 | [⭐ 1.2K](https://github.com/yhArcadia/Yunzai-Bot-plugins-index) |
| LinkSwift | 一个基于 JavaScript 的网盘文件下载地址获取工具。基于【网盘直链下载助手】修改 ，支持 百度网盘 / 阿里云盘 / 中国移动云盘 / 天翼云盘 / 迅雷云盘 / 夸克网盘 / UC网盘 / 123云盘 八大网盘 | [⭐ 1.9W](https://github.com/hmjz100/LinkSwift) |
| telegram-msg-forwa<br>rder | 一个功能强大的Telegram机器人，能够转发指定链接的消息，支持随机消息获取和批量消息管理。 | [⭐ 58](https://github.com/cubezhao/telegram-msg-forwarder) |
...
| ok-wuthering-waves | 鸣潮 后台自动战斗 自动刷声骸 一键日常 Automation for Wuthering Waves | [⭐ 7.1K](https://github.com/ok-oldking/ok-wuthering-waves) |
...
| mc_auto_boss | 鸣潮后台自动刷BOSS声骸 | [⭐ 729](https://github.com/lazydog28/mc_auto_boss) |
...
| openwrt-Exclusive | 暂无描述 | [⭐ 191](https://github.com/firkerword/openwrt-Exclusive) |
...
| Yunzai-Kuro-Plugin | 一个库洛游戏 (战双&鸣潮) 的插件，适用于云崽Bot。 ｜ A Plugin of Kuro Games(Punshining Gray Raven & Wuthering Waves), adapt to Yunzai-Bot. | [⭐ 159](https://github.com/TomyJan/Yunzai-Kuro-Plugin) |
...
| WutheringWaves | Wuthering Waves ps (0.9.0)<br>《鸣潮》PS (0.9.0) | [⭐ 252](https://github.com/thexeondev/WutheringWaves) |
...
| TTSModels | 暂无描述 | [⭐ 624](https://github.com/CjangCjengh/TTSModels) |
| Aoki | Mirai 一键登录处理器 (现已不可用于登录，请使用签名服务) | [⭐ 227](https://github.com/MrXiaoM/Aoki) |
| AstrBot | AI Agent Assistant & development framework that integrates lots of IM platforms, LLMs, plugins and AI feature, and can...<br>AI智能体助手与开发框架，集成了众多即时通讯平台、大语言模型、插件及AI功能，并且可以…… | [⭐ 3.9W](https://github.com/AstrBotDevs/AstrBot) |
...
| docker.ui | 暂无描述 | [⭐ 808](https://github.com/gohutool/docker.ui) |
...
| Android-DataBackup | DataBackup for Android 7.0+<br>适用于 Android 7.0 及以上版本的数据备份 | [⭐ 7.2K](https://github.com/XayahSuSuSu/Android-DataBackup) |
| HelloGitHub | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source projects on GitHub. | [⭐ 17.2W](https://github.com/521xueweihan/HelloGitHub) |
...
| NeverIdle | 资源定期浪费，可用于 Oracle 甲骨文保活。 | [⭐ 978](https://github.com/layou233/NeverIdle) |
...
| luci-app-cloudflar<br>e-ip | OpenWrt Cloudflare IP 优选工具 - 自动测速优选 Cloudflare IP 并更新 PassWall/OpenClash 节点，支持 LuCI Web 界面、定时任务、CFST 自动下载与自更新 | [⭐ 41](https://github.com/hello-yunshu/luci-app-cloudflare-ip) |
