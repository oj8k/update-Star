...
| VoCat | Vocat is an open-source web control panel and engineering toolkit for Quectel EC20/EC25-class cellular modems. It...<br>Vocat 是一个开源网页控制面板和工程工具包，用于移远 EC20/EC25 系列蜂窝调制解调器。它... | [⭐ 763](https://github.com/MengMengCode/VoCat) |
...
| nft-forward | Multi-tenant port-forwarding panel built on nftables (Go, single binary, SQLite)<br>基于nftables构建的多租户端口转发面板（Go语言，单二进制文件，SQLite） | [⭐ 110](https://github.com/xjetry/nft-forward) |
| iCloud_Distributio<br>n | 暂无描述 | [⭐ 21](https://github.com/paipaiio/iCloud_Distribution) |
...
| device_faker | 自定义配置Zygisk机型伪装 | [⭐ 743](https://github.com/Seyud/device_faker) |
| TcpQuality | 暂无描述 | [⭐ 786](https://github.com/ibsgss/TcpQuality) |
| cf-outlook-email | 📬 基于 Cloudflare Workers 的轻量级 Outlook 邮件管理工具 · 免费 · 无需服务器 ｜ Lightweight Outlook email manager, serverless & free ⚡ | [⭐ 255](https://github.com/roseforyou/cf-outlook-email) |
...
| GPT5.6-5.5- | 此项目为gpt5.6/5.5破甲方案 | [⭐ 285](https://github.com/zxr-roro/GPT5.6-5.5-) |
...
| saladict | 🌈一个跨平台的划词翻译和OCR软件 ｜ A cross-platform software for text translation and recognition. | [⭐ 146](https://github.com/allentown521/saladict) |
...
| CLIProxyAPI | Wrap Antigravity, ChatGPT Codex, Claude Code, Grok Build as an OpenAI/Gemini/Claude/Codex compatible API service,...<br>将 Antigravity、ChatGPT Codex、Claude Code、Grok Build 封装为与 OpenAI/Gemini/Claude/Codex 兼容的 API 服务，…… | [⭐ 5.1W](https://github.com/router-for-me/CLIProxyAPI) |
...
| sub2api | Sub2API 一站式开源中转服务，让 Claude、Openai 、Gemini、Grok订阅统一接入，支持拼车共享，更高效分摊成本，原生工具无缝使用。 | [⭐ 4.1W](https://github.com/Wei-Shaw/sub2api) |
...
| tg-vault | Telegram 转存、媒体归档与多存储源私有云系统 | [⭐ 198](https://github.com/hicocos/tg-vault) |
| Netcatty | SSH workspace, SFTP, and terminals in one<br>SSH工作区、SFTP和终端三合一。 | [⭐ 5.7K](https://github.com/binaricat/Netcatty) |
| CF-Server-Monitor | 一个基于 Cloudflare Workers + D1 + Durable Objects 的免费多服务器监控探针系统，支持实时监控、离线告警，到期通知，历史数据查看、延迟追踪、地图展示等功能。兼容主流Linux系统，Alpine... | [⭐ 1.7K](https://github.com/huilang-me/CF-Server-Monitor) |
...
| codex-candy-eval | Codex 降智测试 | [⭐ 949](https://github.com/haowang02/codex-candy-eval) |
...
| vohive-release | 暂无描述 | [⭐ 806](https://github.com/iniwex5/vohive-release) |
| dujiao-next | Dujiao-Next<br>独角-下一代 | [⭐ 1.2K](https://github.com/dujiao-next/dujiao-next) |
| daidai-panel | Lightweight scheduled task management panel, similar to Qinglong Panel. 轻量级定时任务管理面板 | [⭐ 475](https://github.com/linzixuanzz/daidai-panel) |
...
| ds-free-api | DeepSeek网页端API代理，支持OpenAI与Anthropic兼容接口 ｜ OpenAI & Anthropic compatible API proxy for DeepSeek web | [⭐ 661](https://github.com/NIyueeE/ds-free-api) |
...
| flvx | FLVX转发面板 | [⭐ 272](https://github.com/Sagit-chu/flvx) |
...
| sms-jiema | 汇总国外1000个免费手机号接码 - 国外免费手机号验证平台 | [⭐ 348](https://github.com/workwayfi/sms-jiema) |
...
| NapCatQQ | Modern protocol-side framework based on NTQQ<br>基于NTQQ的现代协议侧框架 | [⭐ 1.1W](https://github.com/NapNeko/NapCatQQ) |
...
| NodePassDash | A modern web dashboard for managing NodePass<br>一个用于管理NodePass的现代Web仪表板。 | [⭐ 438](https://github.com/NodePassProject/NodePassDash) |
...
| ok-wuthering-waves | 鸣潮 后台自动战斗 自动刷声骸 一键日常 Automation for Wuthering Waves | [⭐ 7.3K](https://github.com/ok-oldking/ok-wuthering-waves) |
...
| NetworkPanel | 测试您的网速，多出口查询您的ip地址 | [⭐ 972](https://github.com/ljxi/NetworkPanel) |
...
| Are-u-ok | KoolCenter iStore .run Packages<br>KoolCenter iStore .run 软件包 | [⭐ 2.4K](https://github.com/bcseputetto/Are-u-ok) |
...
| NeverIdle | 资源定期浪费，可用于 Oracle 甲骨文保活。 | [⭐ 987](https://github.com/layou233/NeverIdle) |
| Cloud-N1-OpenWrt | Github Actions 自动编译 OpenWrt 固件（适配 Phicomm N1） | [⭐ 324](https://github.com/huangqian8/Cloud-N1-OpenWrt) |
