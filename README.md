...
| worldmonitor | Real-time global intelligence dashb<br>oard. AI-powered news aggregation, <br>geopolitical monitoring, and infras<br>tructure tracking in a unified situ<br>ational awareness interface<br><br><br><i>实时全球情报仪表盘。在一个统一的态势感知界面中，集成了AI驱动的<br>新闻聚合、地缘政治监测和基础设施跟踪功能...</i> | <a href='https://github.com/koala73/worldmonitor' target='_blank'>⭐ 57.7K</a> |
...
| NapCatQQ | Modern protocol-side framework base<br>d on NTQQ<br><br><i>基于 NTQQ 的现代协议侧框<br>架...</i> | <a href='https://github.com/NapNeko/NapCatQQ' target='_blank'>⭐ 9.6K</a> |
...
| vaultwarden | Unofficial Bitwarden compatible ser<br>ver written in Rust, formerly known<br> as bitwarden_rs<br><br><i>非官方的 Bit<br>warden 兼容服务器，使用 Rust 语言编写，原名 bitwar<br>den_rs...</i> | <a href='https://github.com/dani-garcia/vaultwarden' target='_blank'>⭐ 62.6K</a> |
| NodePassDash | A modern web dashboard for managing<br> NodePass<br><br><i>管理 NodePass 的现代<br> Web 控制面板。</i> | <a href='https://github.com/NodePassProject/NodePassDash' target='_blank'>⭐ 430</a> |
...
| watchtower | A process for automating Docker con<br>tainer base image updates. <br><br><br><i>一种用于自动化 Docker 容器基础镜像更新的过程。</i> | <a href='https://github.com/containrrr/watchtower' target='_blank'>⭐ 24.7K</a> |
...
| karakeep | A self-hostable bookmark-everything<br> app (links, notes and images) with<br> AI-based automatic tagging and ful<br>l text search<br><br><i>一个可自托管的万能收藏<br>应用（支持链接、笔记和图片），具备基于AI的自动打标签和全文搜索功能。<br></i> | <a href='https://github.com/karakeep-app/karakeep' target='_blank'>⭐ 26.1K</a> |
...
| ContextMenuManager | 🖱️ 一个管理 Windows 右键上下文菜单的程序（支持Window<br>s 7 - 11）A program to manage the Wi<br>ndows right-click context menu with<br> support of Windows 7 - 11 | <a href='https://github.com/Jack251970/ContextMenuManager' target='_blank'>⭐ 762</a> |
...
| Remove-MS-Edge | Uninstall Microsoft Edge with an ex<br>ecutable or batch script.<br><br><i<br>>通过可执行文件或批处理脚本卸载 Microsoft Edge。</i<br>> | <a href='https://github.com/ShadowWhisperer/Remove-MS-Edge' target='_blank'>⭐ 5.2K</a> |
...
| mtg | Highly opinionated MTPROTO proxy fo<br>r Telegram<br><br><i>预设性很强的 Telegra<br>m MTPROTO 代理...</i> | <a href='https://github.com/9seconds/mtg' target='_blank'>⭐ 3.6K</a> |
...
| 3x-ui | Xray panel supporting multi-protoco<br>l multi-user expire day & traffic &<br> IP limit (Vmess, Vless, Trojan, Sh<br>adowSocks, Wireguard, Hysteria, Tun<br>nel, Mixed, HTTP, Tun) <br><br><i>X<br>ray 面板支持多协议、多用户，并提供有效期、流量和 IP 限制功能 <br>(支持 Vmess, Vless, Trojan, ShadowSoc<br>ks, Wireguard, Hysteria, Tunnel, Mi<br>xed, HTTP, Tun 等协议) ...</i> | <a href='https://github.com/MHSanaei/3x-ui' target='_blank'>⭐ 41.1K</a> |
| IDM-Activation-Scrip<br>t | An open source tool to activate and<br> reset trial of Internet Download M<br>anager<br><br><i>一款开源工具，用于激活和重置 Int<br>ernet Download Manager 的试用期...</i> | <a href='https://github.com/WindowsAddict/IDM-Activation-Script' target='_blank'>⭐ 7.6K</a> |
...
| tabby | A terminal for a more modern age<br<br>><br><i>这里提供几个翻译选项，具体取决于语境和您希望传达的语气<br>：  1.  **面向更现代的时代的终端。** (最直接、准确的翻译)<br> 2.  **为更现代的时代而生的终端。** (更具宣传语或诗意，强调<br>其为新时代而存在) 3.  **现代新时代的终端。** (更简洁，"新<br>时代"本身就包含了"更现代"的意味)  您可以根据具体语境选择最合适的<br>翻译。</i> | <a href='https://github.com/Eugeny/tabby' target='_blank'>⭐ 72.2K</a> |
| WuWa-Configs | WuWa configs to improve visuals or <br>performance<br><br><i>**鸣潮配置：优化画面或性<br>能...**  或者： *   **鸣潮设置：提升画面或性能...**<br> *   **《鸣潮》画面/性能优化配置...**</i> | <a href='https://github.com/AlteriaX/WuWa-Configs' target='_blank'>⭐ 1.6K</a> |
...
| chatGPTBox | Integrating ChatGPT into your brows<br>er deeply, everything you need is h<br>ere<br><br><i>将 ChatGPT 深度集成到您的浏览器，<br>您所需的一切，尽在此处。</i> | <a href='https://github.com/ChatGPTBox-dev/chatGPTBox' target='_blank'>⭐ 10.7K</a> |
...
| WindTerm | A professional cross-platform SSH/S<br>ftp/Shell/Telnet/Tmux/Serial termin<br>al.<br><br><i>一个专业的跨平台SSH/SFTP/Shel<br>l/Telnet/Tmux/串口终端....</i> | <a href='https://github.com/kingToolbox/WindTerm' target='_blank'>⭐ 31.4K</a> |
...
| HelloGitHub | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Sh<br>are interesting, entry-level open s<br>ource projects on GitHub. | <a href='https://github.com/521xueweihan/HelloGitHub' target='_blank'>⭐ 162.1K</a> |
