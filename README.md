...
| 项目名称 | 项目简介 | 项目链接 |
|----------|-----------|:-----------:|
| quickscan | 轻量截屏扫码工具 · Lightweight screen-capture QR scanner (Tauri 2, ~1.3MB installer) | [⭐ 225](https://github.com/yoli-mi/quickscan) |
| WeChat-AI | WeChat AI - 自托管微信角色扮演对话服务 | [⭐ 1.9K](https://github.com/SMNETSTUDIO/WeChat-AI) |
| VoCat | Vocat is an open-source web control panel and engineering toolkit for Quectel EC20/EC25-class cellular modems. It...<br>Vocat 是一个开源网页控制面板和工程工具包，用于移远 EC20/EC25 系列蜂窝调制解调器。它... | [⭐ 828](https://github.com/MengMengCode/VoCat) |
| location-spoofer | 面向 iOS 定位服务行为研究和开发测试的虚拟定位工具，支持地图选点、本地与第三方代理、WGS-84 / GCJ-02 双坐标、环境检测和问题诊断。 | [⭐ 882](https://github.com/xweiba/location-spoofer) |
...
| singbox-deploy | 一个跨平台、自动化、全兼容的 Sing-box 一键部署脚本 | [⭐ 566](https://github.com/caigouzi121380/singbox-deploy) |
| device_faker | 自定义配置Zygisk机型伪装 | [⭐ 754](https://github.com/Seyud/device_faker) |
| TcpQuality | 暂无描述 | [⭐ 849](https://github.com/ibsgss/TcpQuality) |
...
| NetQuality | 网络质量检测脚本 - Network Quality Check Script | [⭐ 5.7K](https://github.com/xykt/NetQuality) |
...
| GPT5.6-5.5- | 此项目为gpt5.6/5.5破甲方案 | [⭐ 290](https://github.com/zxr-roro/GPT5.6-5.5-) |
...
| rustdesk | An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer.<br>一款开源远程桌面应用程序，专为自托管设计，作为TeamViewer的替代方案。 | [⭐ 12.4W](https://github.com/rustdesk/rustdesk) |
...
| Codex-X | OpenAI Codex 桌面端/CLI 的可视化管理工具，具有Provider/API 切换、会话同步、提示词注入、Skills/MCP 管理、TOML 配置可视化的跨平台工具。 | [⭐ 3.2K](https://github.com/yynxxxxx/Codex-X) |
...
| sub2api | Sub2API 一站式开源中转服务，让 Claude、Openai 、Gemini、Grok订阅统一接入，支持拼车共享，更高效分摊成本，原生工具无缝使用。 | [⭐ 4.2W](https://github.com/Wei-Shaw/sub2api) |
...
| Netcatty | SSH workspace, SFTP, and terminals in one<br>SSH工作区、SFTP和终端三合一。 | [⭐ 6.0K](https://github.com/binaricat/Netcatty) |
| CF-Server-Monitor | 一个基于 Cloudflare Workers + D1 + Durable Objects 的免费多服务器监控探针系统，支持实时监控、离线告警，到期通知，历史数据查看、延迟追踪、地图展示等功能。兼容主流Linux系统，Alpine... | [⭐ 1.9K](https://github.com/huilang-me/CF-Server-Monitor) |
...
| vohive-release | 暂无描述 | [⭐ 808](https://github.com/iniwex5/vohive-release) |
| dujiao-next | Dujiao-Next<br>独角-下一代 | [⭐ 1.2K](https://github.com/dujiao-next/dujiao-next) |
| daidai-panel | Lightweight scheduled task management panel, similar to Qinglong Panel. 轻量级定时任务管理面板 | [⭐ 517](https://github.com/linzixuanzz/daidai-panel) |
...
| ds-free-api | DeepSeek网页端API代理，支持OpenAI与Anthropic兼容接口 ｜ OpenAI & Anthropic compatible API proxy for DeepSeek web | [⭐ 692](https://github.com/NIyueeE/ds-free-api) |
...
| sms-jiema | 汇总国外1000个免费手机号接码 - 国外免费手机号验证平台 | [⭐ 364](https://github.com/workwayfi/sms-jiema) |
...
| douyin_downloader | 抖音福袋扭蛋机，抖音抢福袋工具，自己工作之余用VC++写的，功能还包含了一些其他小功能，抖音无水印视频下载器，抖音直播间录制下载器，抖音批量取消关注取关器 | [⭐ 607](https://github.com/testusyd/douyin_downloader) |
...
| nav-item | 导航站 | [⭐ 401](https://github.com/eooce/nav-item) |
...
| ContextMenuManager | 🖱️ 一个管理 Windows 右键上下文菜单的程序（支持Windows 7 - 11）A program to manage the Windows right-click context menu with support of... | [⭐ 929](https://github.com/Jack251970/ContextMenuManager) |
...
| hexhub | Hexhub 是一款开源的SSH、SFTP、数据库管理客户端，数据库管理模块目前还在开发之中 | [⭐ 506](https://github.com/EdikKing/hexhub) |
...
| Yunzai | Yunzai 应用端，支持多账号，支持协议端：go-cqhttp、ComWeChat、GSUIDCore、ICQQ、QQBot、QQ频道、微信、KOOK、Telegram、Discord | [⭐ 621](https://github.com/TimeRainStarSky/Yunzai) |
...
| Anime-Repository | Elegant Smart Scraper<br>优雅智能爬虫 | [⭐ 207](https://github.com/Chikage0o0/Anime-Repository) |
...
| HelloGitHub | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source projects on GitHub. | [⭐ 17.7W](https://github.com/521xueweihan/HelloGitHub) |
...
| Cloud-N1-OpenWrt | Github Actions 自动编译 OpenWrt 固件（适配 Phicomm N1） | [⭐ 325](https://github.com/huangqian8/Cloud-N1-OpenWrt) |
