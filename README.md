...
| singbox-deploy | 一个跨平台、自动化、全兼容的 Sing-box 一键部署脚本 | [⭐ 506](https://github.com/caigouzi121380/singbox-deploy) |
| device_faker | 自定义配置Zygisk机型伪装 | [⭐ 666](https://github.com/Seyud/device_faker) |
| TcpQuality | 暂无描述 | [⭐ 406](https://github.com/ibsgss/TcpQuality) |
...
| NetProxy-Magisk | Based on the sing-box core, this Android proxy module supports one-click start/stop of transparent proxy and is...<br>基于 sing-box 核心，这个 Android 代理模块支持一键启动/停止透明代理，并且是…… | [⭐ 1.0K](https://github.com/Fanju6/NetProxy-Magisk) |
| GPT5.6-5.5- | 此项目为gpt5.6/5.5破甲方案 | [⭐ 194](https://github.com/zxr-roro/GPT5.6-5.5-) |
...
| saladict | 🌈一个跨平台的划词翻译和OCR软件 ｜ A cross-platform software for text translation and recognition. | [⭐ 127](https://github.com/allentown521/saladict) |
| open-reverselab | Agent-native reverse-engineering lab with a 197-article knowledge base, MCP tools, and CTF/APK/PE automation workflows.<br>一个原生代理逆向工程实验室，配备包含197篇文章的知识库、MCP工具，以及CTF/APK/PE自动化工作流。 | [⭐ 969](https://github.com/LING71671/open-reverselab) |
| Codex-X | OpenAI Codex 桌面端/CLI 的可视化管理工具，具有Provider/API 切换、会话同步、提示词注入、Skills/MCP 管理、TOML 配置可视化的跨平台工具。 | [⭐ 2.0K](https://github.com/yynxxxxx/Codex-X) |
...
| dji-4g-vohive-mac | 在 Mac（Apple Silicon / Intel）上用 UTM 跑 Linux 虚拟机，把大疆 4G 模块（EG25-G）伪装成移远 Quectel EC25 并部署 vohive 平台的完整步骤 | [⭐ 870](https://github.com/wlzh/dji-4g-vohive-mac) |
...
| Netcatty | SSH workspace, SFTP, and terminals in one<br>SSH工作区、SFTP和终端三合一。 | [⭐ 4.6K](https://github.com/binaricat/Netcatty) |
...
| codex-candy-eval | Codex 降智测试 | [⭐ 792](https://github.com/haowang02/codex-candy-eval) |
...
| vohive-release | 暂无描述 | [⭐ 776](https://github.com/iniwex5/vohive-release) |
| dujiao-next | Dujiao-Next<br>独角-下一代 | [⭐ 879](https://github.com/dujiao-next/dujiao-next) |
| daidai-panel | Lightweight scheduled task management panel, similar to Qinglong Panel. 轻量级定时任务管理面板 | [⭐ 308](https://github.com/linzixuanzz/daidai-panel) |
...
| ds-free-api | DeepSeek网页端API代理，支持OpenAI与Anthropic兼容接口 ｜ OpenAI & Anthropic compatible API proxy for DeepSeek web | [⭐ 568](https://github.com/NIyueeE/ds-free-api) |
...
| dstatus | DStatus 探针 是一个现代化的服务器状态监控系统，提供简洁美观的UI界面和强大的探针 agent 监控功能。 | [⭐ 400](https://github.com/fev125/dstatus) |
...
| oci-helper | 基于 Oracle OCI SDK 🐢 开发的 web 端可视化甲骨文云助手（Y探长），目前实现的功能有：批量添加多个租户配置、更改实例配置、引导卷配置、一键开启免费AMD实例下行500Mbps、一键更新、一键救援/缩小硬盘、附加ipv6、... | [⭐ 772](https://github.com/Yohann0617/oci-helper) |
...
| ContextMenuManager | 🖱️ 一个管理 Windows 右键上下文菜单的程序（支持Windows 7 - 11）A program to manage the Windows right-click context menu with support of... | [⭐ 858](https://github.com/Jack251970/ContextMenuManager) |
...
| idcard_generator- | 身份证图片生成工具-仅供学习交流。已打包Maocs app和Windows exe，可直接下载使用 | [⭐ 638](https://github.com/xiamuguizhi/idcard_generator-) |
...
| ok-wuthering-waves | 鸣潮 后台自动战斗 自动刷声骸 一键日常 Automation for Wuthering Waves | [⭐ 6.9K](https://github.com/ok-oldking/ok-wuthering-waves) |
...
| mc_auto_boss | 鸣潮后台自动刷BOSS声骸 | [⭐ 731](https://github.com/lazydog28/mc_auto_boss) |
...
| NetworkPanel | 测试您的网速，多出口查询您的ip地址 | [⭐ 967](https://github.com/ljxi/NetworkPanel) |
...
| NeverIdle | 资源定期浪费，可用于 Oracle 甲骨文保活。 | [⭐ 971](https://github.com/layou233/NeverIdle) |
