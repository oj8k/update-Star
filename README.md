...
| 项目名称 | 项目简介 | 项目链接 |
|----------|-----------|:-----------:|
| GPT5.6-5.5- | 此项目为gpt5.6/5.5破甲方案 | [⭐ 166](https://github.com/zxr-roro/GPT5.6-5.5-) |
...
| open-reverselab | Agent-native reverse-engineering lab with a 197-article knowledge base, MCP tools, and CTF/APK/PE automation...<br>一个基于代理原生的逆向工程实验室，拥有197篇文章的知识库、MCP工具以及CTF/APK/PE自动化…… | [⭐ 903](https://github.com/LING71671/open-reverselab) |
| Codex-X | Codex Switch & Instruct desktop manager<br>Codex Switch & Instruct 桌面管理器 | [⭐ 1.6K](https://github.com/yynxxxxx/Codex-X) |
...
| grok-register | 【已存活三个月+，无封号】批量注册稳定 Grok 账号，可直接导入 grok2api 和 cpa 使用，并且可以与cloudflare无限域名邮箱等联动。通过1000+账号连续注册测试。 | [⭐ 1.6K](https://github.com/AaronL725/grok-register) |
...
| dji-4g-vohive-mac | 在 Mac（Apple Silicon / Intel）上用 UTM 跑 Linux 虚拟机，把大疆 4G 模块（EG25-G）伪装成移远 Quectel EC25 并部署 vohive 平台的完整步骤 | [⭐ 755](https://github.com/wlzh/dji-4g-vohive-mac) |
| fluxdo | 一个 Linux.do 第三方客户端 | [⭐ 2.1K](https://github.com/Lingyan000/fluxdo) |
| GeekezBrowser | A professional anti-detect browser built on Electron and Puppeteer, integrated with the powerful Xray-core....<br>一款基于Electron和Puppeteer构建的专业反检测浏览器，集成了强大的Xray-core...... | [⭐ 998](https://github.com/EchoHS/GeekezBrowser) |
| tg-vault | 暂无描述 | [⭐ 137](https://github.com/hicocos/tg-vault) |
| Netcatty | SSH workspace, SFTP, and terminals in one<br>SSH工作区、SFTP和终端三合一。 | [⭐ 4.1K](https://github.com/binaricat/Netcatty) |
| CF-Server-Monitor | 一个基于 Cloudflare Workers + D1 + Durable Objects 的多服务器监控探针系统，支持实时监控、离线告警，到期通知，历史数据查看、延迟追踪、地图展示等功能。兼容主流Linux系统，Alpine... | [⭐ 935](https://github.com/huilang-me/CF-Server-Monitor) |
...
| codex-candy-eval | Codex 降智测试 | [⭐ 774](https://github.com/haowang02/codex-candy-eval) |
...
| vohive-release | 暂无描述 | [⭐ 732](https://github.com/iniwex5/vohive-release) |
| dujiao-next | Dujiao-Next Server 独角Next服务端 | [⭐ 834](https://github.com/dujiao-next/dujiao-next) |
| daidai-panel | Lightweight scheduled task management panel, similar to Qinglong Panel. 轻量级定时任务管理面板 | [⭐ 286](https://github.com/linzixuanzz/daidai-panel) |
...
| ds-free-api | DeepSeek网页端API代理，支持OpenAI与Anthropic兼容接口 ｜ OpenAI & Anthropic compatible API proxy for DeepSeek web | [⭐ 548](https://github.com/NIyueeE/ds-free-api) |
...
| read-frog | 🐸 Read Frog - Open Source Immersive Translate ｜ 🐸 陪读蛙 - 开源沉浸式翻译 | [⭐ 8.7K](https://github.com/mengxi-ream/read-frog) |
...
| flvx | FLVX转发面板 | [⭐ 259](https://github.com/Sagit-chu/flvx) |
...
| worldmonitor | Real-time global intelligence dashboard. AI-powered news aggregation, geopolitical monitoring, and infrastructure...<br>实时全球情报仪表盘。由人工智能驱动的新闻聚合、地缘政治监控及基础设施…… | [⭐ 7.4W](https://github.com/koala73/worldmonitor) |
