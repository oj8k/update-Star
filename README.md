...
| worldmonitor | Real-time global intelligence dashb<br>oard. AI-powered news aggregation, <br>geopolitical monitoring, and infras<br>tructure tracking in a unified situ<br>ational awareness interface<br><br><br><i>（翻译失败）</i> | <a href='https://github.com/koala73/worldmonitor' target='_blank'>⭐ 56.5K</a> |
...
| NapCatQQ | Modern protocol-side framework base<br>d on NTQQ<br><br><i>（翻译失败）</i> | <a href='https://github.com/NapNeko/NapCatQQ' target='_blank'>⭐ 9.5K</a> |
...
| vaultwarden | Unofficial Bitwarden compatible ser<br>ver written in Rust, formerly known<br> as bitwarden_rs<br><br><i>（翻译失败）</<br>i> | <a href='https://github.com/dani-garcia/vaultwarden' target='_blank'>⭐ 62.4K</a> |
...
| watchtower | A process for automating Docker con<br>tainer base image updates. <br><br><br><i>自动化 Docker 容器基础镜像更新的流程。</i> | <a href='https://github.com/containrrr/watchtower' target='_blank'>⭐ 24.7K</a> |
...
| cloud-mail | A Cloudflare-based email service  ｜<br> 基于 Cloudflare 的邮箱服务  ｜ Cloudflare <br>Email 邮箱 Mail | <a href='https://github.com/maillab/cloud-mail' target='_blank'>⭐ 11.2K</a> |
| ContextMenuManager | 🖱️ 一个管理 Windows 右键上下文菜单的程序（支持Window<br>s 7 - 11）A program to manage the Wi<br>ndows right-click context menu with<br> support of Windows 7 - 11 | <a href='https://github.com/Jack251970/ContextMenuManager' target='_blank'>⭐ 754</a> |
...
| hexhub | Hexhub 是一款开源的SSH、SFTP、数据库管理客户端，数据库管<br>理模块目前还在开发之中 | <a href='https://github.com/EdikKing/hexhub' target='_blank'>⭐ 428</a> |
...
| LinkSwift | 一个基于 JavaScript 的网盘文件下载地址获取工具。基于【网盘<br>直链下载助手】修改 ，支持 百度网盘 / 阿里云盘 / 中国移动云盘 <br>/ 天翼云盘 / 迅雷云盘 / 夸克网盘 / UC网盘 / 123云盘<br> 八大网盘 | <a href='https://github.com/hmjz100/LinkSwift' target='_blank'>⭐ 16.4K</a> |
...
| 3x-ui | Xray panel supporting multi-protoco<br>l multi-user expire day & traffic &<br> IP limit (Vmess, Vless, Trojan, Sh<br>adowSocks, Wireguard, Hysteria, Tun<br>nel, Mixed, HTTP, Tun) <br><br><i>（<br>翻译失败）</i> | <a href='https://github.com/MHSanaei/3x-ui' target='_blank'>⭐ 40.7K</a> |
...
| NetworkPanel | 测试您的网速，多出口查询您的ip地址 | <a href='https://github.com/ljxi/NetworkPanel' target='_blank'>⭐ 943</a> |
...
| AstrBot | AI Agent Assistant & development fr<br>amework that integrates lots of IM <br>platforms, LLMs, plugins and AI fea<br>ture, and can be your openclaw alte<br>rnative. ✨ | <a href='https://github.com/AstrBotDevs/AstrBot' target='_blank'>⭐ 34.7K</a> |
...
| chatbox | Powerful AI Client<br><br><i>强大的 AI<br> 客户端...</i> | <a href='https://github.com/chatboxai/chatbox' target='_blank'>⭐ 40.5K</a> |
| auto_wjx | 不会有人连问卷星都要弄虚作假吧 | <a href='https://github.com/Lihewin/auto_wjx' target='_blank'>⭐ 4</a> |
| chatGPTBox | Integrating ChatGPT into your brows<br>er deeply, everything you need is h<br>ere<br><br><i>这里提供几个翻译版本，各有侧重：  **版<br>本一 (更流畅、更具宣传性)：** 将ChatGPT深度融入您的浏览器<br>，一切所需，尽在掌握...  **版本二 (更直接、专业)：** 将C<br>hatGPT深度集成至您的浏览器，您所需的一切尽在此处...  **版<br>本三 (简洁明了)：** ChatGPT深度整合到浏览器，您所需的一切<br>都在这里...  我推荐使用**版本一**，它在中文语境下听起来更自然<br>、更有吸引力，尤其适合产品宣传。</i> | <a href='https://github.com/ChatGPTBox-dev/chatGPTBox' target='_blank'>⭐ 10.7K</a> |
...
| HelloGitHub | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Sh<br>are interesting, entry-level open s<br>ource projects on GitHub. | <a href='https://github.com/521xueweihan/HelloGitHub' target='_blank'>⭐ 161.4K</a> |
...
| luci-app-cloudflare-<br>ip | OpenWrt Cloudflare IP 优选工具 - 自动测速优选<br> Cloudflare IP 并更新 PassWall/OpenCla<br>sh 节点，支持 LuCI Web 界面、定时任务、CFST 自动下载<br>与自更新 | <a href='https://github.com/hello-yunshu/luci-app-cloudflare-ip' target='_blank'>⭐ 32</a> |
