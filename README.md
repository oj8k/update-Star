...
| NapCatQQ | Modern protocol-side framework base<br>d on NTQQ<br><br><i>基于NTQQ的现代协议端框架.<br>..</i> | <a href='https://github.com/NapNeko/NapCatQQ' target='_blank'>⭐ 9.5K</a> |
...
| vaultwarden | Unofficial Bitwarden compatible ser<br>ver written in Rust, formerly known<br> as bitwarden_rs<br><br><i>用 Rust 编<br>写的非官方 Bitwarden 兼容服务器，前身为 bitwarden<br>_rs...</i> | <a href='https://github.com/dani-garcia/vaultwarden' target='_blank'>⭐ 62.4K</a> |
| NodePassDash | A modern web dashboard for managing<br> NodePass<br><br><i>以下是几种翻译方式，各有侧重：<br>  1.  **现代化网页管理面板，用于管理 NodePass。** <br>    *   这是最直接和常用的翻译，"管理面板" (managem<br>ent panel) 是 "dashboard" 在管理系统语境下的常<br>见译法。  2.  **用于管理 NodePass 的现代化网页仪表盘<br>。**     *   保留了 "仪表盘" (dashboard) 的<br>字面意思，并强调其用途。  3.  **NodePass 现代化网络管<br>理后台。**     *   如果这个 dashboard 是一个后台<br>管理系统，"后台" (backend/admin panel) 是一个<br>非常地道且常用的说法。  您可以根据具体语境选择最合适的翻译。我个人推<br>荐第一种或第三种，它们在中文语境下更自然。</i> | <a href='https://github.com/NodePassProject/NodePassDash' target='_blank'>⭐ 430</a> |
...
| nftables-nat-rust | nftables nat规则生成器 | <a href='https://github.com/arloor/nftables-nat-rust' target='_blank'>⭐ 928</a> |
...
| ContextMenuManager | 🖱️ 一个管理 Windows 右键上下文菜单的程序（支持Window<br>s 7 - 11）A program to manage the Wi<br>ndows right-click context menu with<br> support of Windows 7 - 11 | <a href='https://github.com/Jack251970/ContextMenuManager' target='_blank'>⭐ 756</a> |
...
| cherry-studio | AI productivity studio with smart c<br>hat, autonomous agents, and 300+ as<br>sistants. Unified access to frontie<br>r LLMs<br><br><i>（翻译失败）</i> | <a href='https://github.com/CherryHQ/cherry-studio' target='_blank'>⭐ 47.4K</a> |
...
| LinkSwift | 一个基于 JavaScript 的网盘文件下载地址获取工具。基于【网盘<br>直链下载助手】修改 ，支持 百度网盘 / 阿里云盘 / 中国移动云盘 <br>/ 天翼云盘 / 迅雷云盘 / 夸克网盘 / UC网盘 / 123云盘<br> 八大网盘 | <a href='https://github.com/hmjz100/LinkSwift' target='_blank'>⭐ 16.5K</a> |
...
| nas-tools | A fork of NAStool/nas-tools:2.9.1<b<br>r><br><i>NAStool/nas-tools 2.9.1 的一<br>个分支...</i> | <a href='https://github.com/receyuki/nas-tools' target='_blank'>⭐ 495</a> |
...
| HelloGitHub | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Sh<br>are interesting, entry-level open s<br>ource projects on GitHub. | <a href='https://github.com/521xueweihan/HelloGitHub' target='_blank'>⭐ 161.5K</a> |
...
| HowToCook | Programmer's guide about how to coo<br>k at home.<br><br><i>（翻译失败）</i> | <a href='https://github.com/Anduin2017/HowToCook' target='_blank'>⭐ 100.8K</a> |
