...
| 项目名称 | 项目简介 | 项目链接 |
|----------|-----------|:-----------:|
| fluxdo | 一个 Linux.do 第三方客户端 | [⭐ 1.9K](https://github.com/Lingyan000/fluxdo) |
| GeekezBrowser | A professional anti-detect browser built on Electron and Puppeteer, integrated with the powerful Xray-core....<br>一款基于Electron和Puppeteer构建的专业反检测浏览器，集成了强大的Xray-core...... | [⭐ 936](https://github.com/EchoHS/GeekezBrowser) |
| tg-vault | 暂无描述 | [⭐ 75](https://github.com/hicocos/tg-vault) |
| Netcatty | SSH workspace, SFTP, and terminals in one<br>SSH工作区、SFTP和终端三合一。 | [⭐ 3.1K](https://github.com/binaricat/Netcatty) |
| CF-Server-Monitor | 一个基于 Cloudflare Workers + D1 + Durable Objects 的多服务器监控探针系统，支持实时监控、历史数据查看、延迟追踪、地图展示等功能。兼容主流Linux系统，Alpine... | [⭐ 651](https://github.com/huilang-me/CF-Server-Monitor) |
| argosbx | 小白自建代理神器！ArgoSBX一键无交互小钢炮脚本💣：Sing-box、Xray、Argo三内核自动搭配；支持VPS、Docker、容器多环境部署；套CDN的5大方案+套WARP的15种组合；已支持协议：AnyTLS、Any-realit... | [⭐ 5.4K](https://github.com/yonggekkk/argosbx) |
| codex-candy-eval | Codex 降智测试 | [⭐ 391](https://github.com/haowang02/codex-candy-eval) |
| cc-switch | A cross-platform desktop All-in-One assistant for Claude Code, Codex, OpenCode, OpenClaw, Gemini CLI & Hermes Agent....<br>一个跨平台的桌面一体化助手，适用于Claude Code、Codex、OpenCode、OpenClaw、Gemini CLI和Hermes Agent等。 | [⭐ 11.3W](https://github.com/farion1231/cc-switch) |
| CodexPlusPlus | An enhanced tool for CodexApp, striving to make Codex better to use and more comfortable...<br>一款针对CodexApp的增强工具，致力于让Codex更好用、更舒适…… | [⭐ 2.3W](https://github.com/BigPizzaV3/CodexPlusPlus) |
| vohive-release | 暂无描述 | [⭐ 642](https://github.com/iniwex5/vohive-release) |
| dujiao-next | Dujiao-Next Server 独角Next服务端 | [⭐ 765](https://github.com/dujiao-next/dujiao-next) |
| daidai-panel | Lightweight scheduled task management panel, similar to Qinglong Panel. 轻量级定时任务管理面板 | [⭐ 261](https://github.com/linzixuanzz/daidai-panel) |
| carrier-ims-for-pi<br>xel | Carrier IMS for Pixel (TurboIMS): multilingual (中文/English) pixel ims / ims / carrierconfig / volte / vowifi / 5G+... | [⭐ 1.0K](https://github.com/ryfineZ/carrier-ims-for-pixel) |
| ds-free-api | DeepSeek网页端API代理，支持OpenAI与Anthropic兼容接口 ｜ OpenAI & Anthropic compatible API proxy for DeepSeek web | [⭐ 523](https://github.com/NIyueeE/ds-free-api) |
| karing | Simple & Powerful proxy utility, Support routing rules for clash/sing-box<br>简单而强大的代理工具，支持 clash/sing-box 的路由规则。 | [⭐ 1.3W](https://github.com/KaringX/karing) |
| read-frog | 🐸 Read Frog - Open Source Immersive Translate ｜ 🐸 陪读蛙 - 开源沉浸式翻译 | [⭐ 8.3K](https://github.com/mengxi-ream/read-frog) |
| clash-rules | 🦄️ 🎃 👻 Clash Premium 规则集(RULE-SET)，兼容 ClashX Pro、Clash for Windows 等基于 Clash Premium 内核的客户端。 | [⭐ 2.7W](https://github.com/Loyalsoldier/clash-rules) |
| meta-rules-dat | rules-dat for mihomo<br>mihomo 的规则 dat 文件 | [⭐ 4.7K](https://github.com/MetaCubeX/meta-rules-dat) |
| Xray | 最好用的 Xray 一键安装脚本 & 管理脚本 | [⭐ 15](https://github.com/justypist/Xray) |
| Sing-box | 既然来了，就留下你的Star吧！Serv00 ｜ CT8 ｜ Hostuno ｜ VPS ｜ 游戏机 ｜ sing-box(reality + hy2 + vmess-argo... | [⭐ 4.9K](https://github.com/eooce/Sing-box) |
| flvx | FLVX转发面板 | [⭐ 247](https://github.com/Sagit-chu/flvx) |
| dstatus | DStatus 探针 是一个现代化的服务器状态监控系统，提供简洁美观的UI界面和强大的探针 agent 监控功能。 | [⭐ 389](https://github.com/fev125/dstatus) |
| linuxdo-checkin | linux.do Daily Check-In. 每日签到，每日打卡 | [⭐ 326](https://github.com/doveppp/linuxdo-checkin) |
| aimili-vpngate | aimili-vpngate是一个借助vpngate.net让Linux用干净ip出站的代理工具。 | [⭐ 1.3K](https://github.com/baoweise-bot/aimili-vpngate) |
| DTV | 抖音、b站、斗鱼、虎牙跨平台轻量化桌面客户端 | [⭐ 1.8K](https://github.com/chen-zeong/DTV) |
| sms-jiema | 汇总国外1000个免费手机号接码 - 国外免费手机号验证平台 | [⭐ 281](https://github.com/workwayfi/sms-jiema) |
| worldmonitor | Real-time global intelligence dashboard. AI-powered news aggregation, geopolitical monitoring, and infrastructure...<br>实时全球情报仪表盘。由人工智能驱动的新闻聚合、地缘政治监控及基础设施…… | [⭐ 6.1W](https://github.com/koala73/worldmonitor) |
...
| douyin_downloader | 抖音福袋扭蛋机，抖音抢福袋工具，自己工作之余用VC++写的，功能还包含了一些其他小功能，抖音无水印视频下载器，抖音直播间录制下载器，抖音批量取消关注取关器 | [⭐ 604](https://github.com/testusyd/douyin_downloader) |
| medicine | 原研药列表 | [⭐ 1.4K](https://github.com/lvwzhen/medicine) |
| free-proxy-list | a free rotating proxy API with tested HTTPS and SOCKS5 proxies from 100+ countries<br>一个免费的轮换代理API，提供来自100多个国家的经过测试的HTTPS和SOCKS5代理。 | [⭐ 6.0K](https://github.com/proxifly/free-proxy-list) |
| acg-faka | 个人发卡源码，发卡系统，二次元发卡系统，二次元发卡源码，发卡程序，动漫发卡，PHP发卡源码，异次元发卡 | [⭐ 5.2K](https://github.com/lizhipay/acg-faka) |
...
| Awesome-NAS-Docker | 一个专注于 NAS 和 Docker 部署的开源项目合集，覆盖 AI、开发、数据管理、多媒体、运维等场景，提供一键式部署指南和实用教程，让 NAS 变身全能生产力工具！ | [⭐ 4.1K](https://github.com/TWO-ICE/Awesome-NAS-Docker) |
| opentrace | Open Source Visualized Route Tracing Tool for macOS, Windows, and Linux.<br>面向macOS、Windows和Linux的开源可视化路由追踪工具。 | [⭐ 4.3K](https://github.com/Archeb/opentrace) |
...
| NapCatQQ | Modern protocol-side framework based on NTQQ<br>基于NTQQ的现代协议侧框架 | [⭐ 9.7K](https://github.com/NapNeko/NapCatQQ) |
| s-ui | An advanced Web Panel • Built for SagerNet/Sing-Box<br>一个高级Web面板 • 专为SagerNet/Sing-Box打造 | [⭐ 9.4K](https://github.com/alireza0/s-ui) |
...
| cloudflare_temp_em<br>ail | CloudFlare free temp domain email 免费收发 临时域名邮箱 支持附件 IMAP SMTP TelegramBot | [⭐ 1.0W](https://github.com/dreamhunter2333/cloudflare_temp_email) |
| oci-helper | 基于 Oracle OCI SDK 🐢 开发的 web 端可视化甲骨文云助手（Y探长），目前实现的功能有：批量添加多个租户配置、更改实例配置、引导卷配置、一键开启免费AMD实例下行500Mbps、一键更新、一键救援/缩小硬盘、附加ipv6、... | [⭐ 742](https://github.com/Yohann0617/oci-helper) |
| vaultwarden | Unofficial Bitwarden compatible server written in Rust, formerly known as bitwarden_rs<br>用Rust编写的非官方Bitwarden兼容服务器，以前称为bitwarden_rs。 | [⭐ 6.3W](https://github.com/dani-garcia/vaultwarden) |
| NodePassDash | A modern web dashboard for managing NodePass<br>一个用于管理NodePass的现代Web仪表板。 | [⭐ 429](https://github.com/NodePassProject/NodePassDash) |
| flux-panel | 基于gost的转发面板 | [⭐ 169](https://github.com/BrunuhVille/flux-panel) |
| nav-item | 导航站 | [⭐ 370](https://github.com/eooce/nav-item) |
...
| NodeSeekSignin | NodeSeek 论坛自动签到Cookie版，支持青龙、直接运行、钉钉机器人通知。 | [⭐ 37](https://github.com/wugeng20/NodeSeekSignin) |
| nftables-nat-rust | nftables nat规则生成器 | [⭐ 939](https://github.com/arloor/nftables-nat-rust) |
...
| UniBoard | 个人介绍，导航页、笔记、短链、文件分享、探针，私有化部署。Profile、Note、ShortURL、FileSharing、probeMonitor…… with self-host | [⭐ 240](https://github.com/Coooolfan/UniBoard) |
| ChinaTextbook | 所有小初高、大学PDF教材。 | [⭐ 7.5W](https://github.com/TapXWorld/ChinaTextbook) |
...
| karakeep | A self-hostable bookmark-everything app (links, notes and images) with AI-based automatic tagging and full text search<br>一个可自托管的书签全能应用（支持链接、笔记和图片），具备基于AI的自动标签和全文搜索功能。 | [⭐ 2.6W](https://github.com/karakeep-app/karakeep) |
| reinstall | 一键DD/重装脚本 (One-click reinstall OS on VPS) | [⭐ 1.2W](https://github.com/bin456789/reinstall) |
| cloud-mail | A Cloudflare-based email service ｜ 基于 Cloudflare 的邮箱服务 ｜ Cloudflare Email 邮箱 Mail | [⭐ 1.2W](https://github.com/maillab/cloud-mail) |
| ContextMenuManager | 🖱️ 一个管理 Windows 右键上下文菜单的程序（支持Windows 7 - 11）A program to manage the Windows right-click context menu with support of... | [⭐ 791](https://github.com/Jack251970/ContextMenuManager) |
...
| komari-theme-purca<br>rte | 一个为 Komari 设计的磨砂玻璃风格主题 | [⭐ 417](https://github.com/Montia37/komari-theme-purcarte) |
| NodeQuality | 在沙箱环境中运行vps测试脚本，并排版测试结果 | [⭐ 1.8K](https://github.com/LloydAsp/NodeQuality) |
| subs-check | 订阅转换、测速、测活、流媒体检测、重命名、导出为任意格式订阅的工具 | [⭐ 5.0K](https://github.com/beck-8/subs-check) |
...
| komari | A simple server monitor tool.<br>一个简单的服务器监控工具。 | [⭐ 5.2K](https://github.com/komari-monitor/komari) |
| aya | Android ADB desktop app<br>Android ADB桌面应用程序 | [⭐ 5.2K](https://github.com/liriliri/aya) |
...
| AiNiee | 一款专注于Ai翻译的工具，一键自动翻译RPG SLG游戏，Epub TXT小说，PDF Word MD文档，Srt Vtt Lrc字幕等等复杂长文本。 | [⭐ 5.9K](https://github.com/NEKOparapa/AiNiee) |
| Duckfolio | 个人主页 | [⭐ 79](https://github.com/Yorlg/Duckfolio) |
...
| idcard_generator- | 身份证图片生成工具-仅供学习交流。已打包Maocs app和Windows exe，可直接下载使用 | [⭐ 606](https://github.com/xiamuguizhi/idcard_generator-) |
| OpenList | A new AList Fork to Anti Trust Crisis<br>一个新的AList分叉，以对抗信任危机。 | [⭐ 2.3W](https://github.com/OpenListTeam/OpenList) |
| lucky | 软硬路由公网神器,ipv6/ipv4 端口转发,反向代理,DDNS,WOL,ipv4 stun内网穿透,cron,acme,rclone,ftp,webdav,filebrowser | [⭐ 7.9K](https://github.com/gdy666/lucky) |
| cherry-studio | AI productivity studio with smart chat, autonomous agents, and 300+ assistants. Unified access to frontier LLMs<br>AI生产力工作室，具备智能聊天、自主代理以及300多个助手功能。统一接入前沿大语言模型。 | [⭐ 4.8W](https://github.com/CherryHQ/cherry-studio) |
...
| portainer-ce | portainer-ce 2.33.x 中文汉化版docker镜像，支持X86、ARM、ARM64、Windows | [⭐ 930](https://github.com/eysp/portainer-ce) |
| hexhub | Hexhub 是一款开源的SSH、SFTP、数据库管理客户端，数据库管理模块目前还在开发之中 | [⭐ 452](https://github.com/EdikKing/hexhub) |
...
| ecs | VPS 融合怪服务器测评项目 更推荐使用无环境依赖的Go版本 VPS Fusion Monster Server Test Script – More recommended to use the Go version with no... | [⭐ 7.0K](https://github.com/spiritLHLS/ecs) |
...
| new-api | A unified AI model hub for aggregation & distribution. It supports cross-converting various LLMs into...<br>一个统一的人工智能模型中心，用于聚合与分发。它支持将各种大语言模型相互转换为…… | [⭐ 4.1W](https://github.com/QuantumNous/new-api) |
| mtg | Highly opinionated MTPROTO proxy for Telegram<br>高度个性化的Telegram MTProto代理 | [⭐ 3.6K](https://github.com/9seconds/mtg) |
| Yunzai | Yunzai 应用端，支持多账号，支持协议端：go-cqhttp、ComWeChat、GSUIDCore、ICQQ、QQBot、QQ频道、微信、KOOK、Telegram、Discord | [⭐ 604](https://github.com/TimeRainStarSky/Yunzai) |
| Yunzai-Bot-plugins<br>-index | Yunzai-Bot云崽QQ机器人插件索引 | [⭐ 1.2K](https://github.com/yhArcadia/Yunzai-Bot-plugins-index) |
| LinkSwift | 一个基于 JavaScript 的网盘文件下载地址获取工具。基于【网盘直链下载助手】修改 ，支持 百度网盘 / 阿里云盘 / 中国移动云盘 / 天翼云盘 / 迅雷云盘 / 夸克网盘 / UC网盘 / 123云盘 八大网盘 | [⭐ 1.7W](https://github.com/hmjz100/LinkSwift) |
...
| ok-wuthering-waves | 鸣潮 后台自动战斗 自动刷声骸 一键日常 Automation for Wuthering Waves | [⭐ 6.7K](https://github.com/ok-oldking/ok-wuthering-waves) |
...
| 3x-ui | Xray panel supporting multi-protocol multi-user expire day & traffic & IP limit (Vmess, Vless, Trojan, ShadowSocks,...<br>Xray面板支持多协议、多用户的到期日期、流量及IP限制（Vmess、Vless、Trojan、ShadowSocks等）。 | [⭐ 4.2W](https://github.com/MHSanaei/3x-ui) |
| IDM-Activation-Scr<br>ipt | An open source tool to activate and reset trial of Internet Download Manager<br>一个开源工具，用于激活和重置 Internet Download Manager 的试用期。 | [⭐ 7.6K](https://github.com/WindowsAddict/IDM-Activation-Script) |
...
| mc_auto_boss | 鸣潮后台自动刷BOSS声骸 | [⭐ 736](https://github.com/lazydog28/mc_auto_boss) |
| MobileModels | 手机品牌型号汇总 ｜ Mobile Models ｜ This repository is licensed under CC BY-NC-SA 4.0 | [⭐ 4.2K](https://github.com/KHwang9883/MobileModels) |
| openwrt-Exclusive | 暂无描述 | [⭐ 192](https://github.com/firkerword/openwrt-Exclusive) |
| NetworkPanel | 测试您的网速，多出口查询您的ip地址 | [⭐ 951](https://github.com/ljxi/NetworkPanel) |
| guoba-plugin | Yunzai-Bot的插件，主要提供后台管理界面。 | [⭐ 236](https://github.com/guoba-yunzai/guoba-plugin) |
| Qsign | Windows的一键搭建签名api | [⭐ 191](https://github.com/touchscale/Qsign) |
| Miao-Yunzai | 喵版Yunzai-V3 | [⭐ 1.1K](https://github.com/yoimiya-kokomi/Miao-Yunzai) |
| waves-plugin | 基于 Yunzai 的鸣潮游戏数据查询插件 | [⭐ 325](https://github.com/erzaozi/waves-plugin) |
| nonebot-plugin-wut<br>heringwaves | NoneBot2 - 鸣潮签到机器人 - 库街区 | [⭐ 5](https://github.com/Night-stars-1/nonebot-plugin-wutheringwaves) |
| Yunzai-Kuro-Plugin | 一个库洛游戏 (战双&鸣潮) 的插件，适用于云崽Bot。 ｜ A Plugin of Kuro Games(Punshining Gray Raven & Wuthering Waves), adapt to Yunzai-Bot. | [⭐ 155](https://github.com/TomyJan/Yunzai-Kuro-Plugin) |
| Wuthering_Waves_Au<br>to | 鸣潮自动脚本 | [⭐ 29](https://github.com/linyys/Wuthering_Waves_Auto) |
| TTime | 🚀 Screenshots, word marking, OCR, AI, translation software ｜｜ 截图、划词、文字识别、AI、翻译软件 | [⭐ 3.2K](https://github.com/InkTimeRecord/TTime) |
...
| NextChat | ✨ Light and Fast AI Assistant. Support: Web ｜ iOS ｜ MacOS ｜ Android ｜ Linux ｜ Windows<br>✨ 轻量快速的人工智能助手。支持：Web ｜ iOS ｜ MacOS ｜ Android ｜ Linux ｜ Windows | [⭐ 8.8W](https://github.com/ChatGPTNextWeb/NextChat) |
...
| cook | 🍲 好的，今天我们来做菜！OK, Let's Cook! | [⭐ 6.4K](https://github.com/YunYouJun/cook) |
...
| AstrBot | AI Agent Assistant & development framework that integrates lots of IM platforms, LLMs, plugins and AI feature, and can...<br>AI智能体助手与开发框架，集成了众多即时通讯平台、大语言模型、插件及AI功能，并且可以…… | [⭐ 3.6W](https://github.com/AstrBotDevs/AstrBot) |
...
| auto_wjx | 不会有人连问卷星都要弄虚作假吧 | [⭐ 4](https://github.com/Lihewin/auto_wjx) |
...
| CasaOS | CasaOS - A simple, easy-to-use, elegant open-source Personal Cloud system.<br>CasaOS - 一个简单、易用、优雅的开源个人云系统。 | [⭐ 3.6W](https://github.com/IceWhaleTech/CasaOS) |
...
| Ehviewer_CN_SXJ | ehviewer，用爱发电，快乐前行 | [⭐ 2.5W](https://github.com/xiaojieonly/Ehviewer_CN_SXJ) |
...
| Android-DataBackup | DataBackup for Android 7.0+<br>适用于 Android 7.0 及以上版本的数据备份 | [⭐ 7.0K](https://github.com/XayahSuSuSu/Android-DataBackup) |
| HelloGitHub | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source projects on GitHub. | [⭐ 16.4W](https://github.com/521xueweihan/HelloGitHub) |
...
| NeverIdle | 资源定期浪费，可用于 Oracle 甲骨文保活。 | [⭐ 962](https://github.com/layou233/NeverIdle) |
| Cloud-N1-OpenWrt | Github Actions 自动编译 OpenWrt 固件（适配 Phicomm N1） | [⭐ 314](https://github.com/huangqian8/Cloud-N1-OpenWrt) |
| Kwrt | openwrt 软路由固件 | [⭐ 8.9K](https://github.com/kiddin9/Kwrt) |
...
| ChatGPT | 🔮 ChatGPT Desktop Application (Mac, Windows and Linux)<br>🔮 ChatGPT 桌面应用程序（Mac、Windows 和 Linux） | [⭐ 5.4W](https://github.com/lencx/ChatGPT) |
| BiliBiliToolPro | B 站（bilibili）自动任务工具，支持docker、青龙、k8s等多种部署方式。全面拥抱AI。敏感肌也能用。 | [⭐ 8.7K](https://github.com/RayWangQvQ/BiliBiliToolPro) |
...
| luci-app-cloudflar<br>e-ip | OpenWrt Cloudflare IP 优选工具 - 自动测速优选 Cloudflare IP 并更新 PassWall/OpenClash 节点，支持 LuCI Web 界面、定时任务、CFST 自动下载与自更新 | [⭐ 36](https://github.com/hello-yunshu/luci-app-cloudflare-ip) |
...
| openwrt-packages | openwrt常用软件包 | [⭐ 7.1K](https://github.com/kenzok8/openwrt-packages) |
| lede | Lean's LEDE source<br>Lean 的 LEDE 源码 | [⭐ 3.1W](https://github.com/coolsnowwolf/lede) |
...
| My-Actions | 爱奇艺会员,腾讯视频,哔哩哔哩,百度,各类签到 | [⭐ 508](https://github.com/MayoBlueSky/My-Actions) |
| python_sign | 联通营业厅签到,GLaDOS签到,腾讯视频签到,CSDN签到,每日新闻生成,掘金签到抽奖,邮件批量发送,leetcode每日一题,线报推送,更多脚本正在开发中! | [⭐ 261](https://github.com/wangwangit/python_sign) |
