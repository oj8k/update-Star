...
| 项目名称 | 项目简介 | 项目链接 |
|----------|-----------|:-----------:|
| quickscan | 轻量截屏扫码工具 · Lightweight screen-capture QR scanner (Tauri 2, ~1.3MB installer) | [⭐ 204](https://github.com/yoli-mi/quickscan) |
| WeChat-AI | WeChat AI - 自托管微信角色扮演对话服务 | [⭐ 1.9K](https://github.com/SMNETSTUDIO/WeChat-AI) |
| VoCat | Vocat is an open-source web control panel and engineering toolkit for Quectel EC20/EC25-class cellular modems. It...<br>Vocat 是一个开源网页控制面板和工程工具包，用于移远 EC20/EC25 系列蜂窝调制解调器。它... | [⭐ 808](https://github.com/MengMengCode/VoCat) |
| location-spoofer | 面向 iOS 定位服务行为研究和开发测试的虚拟定位工具，支持地图选点、本地与第三方代理、WGS-84 / GCJ-02 双坐标、环境检测和问题诊断。 | [⭐ 848](https://github.com/xweiba/location-spoofer) |
...
| singbox-deploy | 一个跨平台、自动化、全兼容的 Sing-box 一键部署脚本 | [⭐ 563](https://github.com/caigouzi121380/singbox-deploy) |
| device_faker | 自定义配置Zygisk机型伪装 | [⭐ 751](https://github.com/Seyud/device_faker) |
| TcpQuality | 暂无描述 | [⭐ 832](https://github.com/ibsgss/TcpQuality) |
...
| GPT5.6-5.5- | 此项目为gpt5.6/5.5破甲方案 | [⭐ 288](https://github.com/zxr-roro/GPT5.6-5.5-) |
...
| codex-candy-eval | Codex 降智测试 | [⭐ 1.0K](https://github.com/haowang02/codex-candy-eval) |
...
| daidai-panel | Lightweight scheduled task management panel, similar to Qinglong Panel. 轻量级定时任务管理面板 | [⭐ 505](https://github.com/linzixuanzz/daidai-panel) |
...
| meta-rules-dat | rules-dat for mihomo<br>mihomo 的规则 dat 文件 | [⭐ 5.2K](https://github.com/MetaCubeX/meta-rules-dat) |
...
| flvx | FLVX转发面板 | [⭐ 273](https://github.com/Sagit-chu/flvx) |
...
| oci-helper | 基于 Oracle OCI SDK 🐢 开发的 web 端可视化甲骨文云助手（Y探长），目前实现的功能有：批量添加多个租户配置、更改实例配置、引导卷配置、一键开启免费AMD实例下行500Mbps、一键更新、一键救援/缩小硬盘、附加ipv6、... | [⭐ 806](https://github.com/Yohann0617/oci-helper) |
...
| nav-item | 导航站 | [⭐ 398](https://github.com/eooce/nav-item) |
...
| ContextMenuManager | 🖱️ 一个管理 Windows 右键上下文菜单的程序（支持Windows 7 - 11）A program to manage the Windows right-click context menu with support of... | [⭐ 924](https://github.com/Jack251970/ContextMenuManager) |
...
| docker.ui | 暂无描述 | [⭐ 805](https://github.com/gohutool/docker.ui) |
