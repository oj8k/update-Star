...
| 项目名称 | 项目简介 | 项目链接 |
|----------|-----------|:-----------:|
| quickscan | 轻量截屏扫码工具 · Lightweight screen-capture QR scanner (Tauri 2, ~1.3MB installer) | [⭐ 258](https://github.com/yoli-mi/quickscan) |
| WeChat-AI | WeChat AI - 自托管微信角色扮演对话服务 | [⭐ 1.9K](https://github.com/SMNETSTUDIO/WeChat-AI) |
| VoCat | Vocat is an open-source web control panel and engineering toolkit for Quectel EC20/EC25-class cellular modems. It...<br>Vocat 是一个开源网页控制面板和工程工具包，用于移远 EC20/EC25 系列蜂窝调制解调器。它... | [⭐ 928](https://github.com/MengMengCode/VoCat) |
| location-spoofer | 面向 iOS 定位服务行为研究和开发测试的虚拟定位工具，支持地图选点、本地与第三方代理、WGS-84 / GCJ-02 双坐标、环境检测和问题诊断。 | [⭐ 926](https://github.com/xweiba/location-spoofer) |
...
| singbox-deploy | 一个跨平台、自动化、全兼容的 Sing-box 一键部署脚本 | [⭐ 578](https://github.com/caigouzi121380/singbox-deploy) |
| device_faker | 自定义配置Zygisk机型伪装 | [⭐ 770](https://github.com/Seyud/device_faker) |
| TcpQuality | 暂无描述 | [⭐ 899](https://github.com/ibsgss/TcpQuality) |
...
| GPT5.6-5.5- | 此项目为gpt5.6/5.5破甲方案 | [⭐ 306](https://github.com/zxr-roro/GPT5.6-5.5-) |
...
| Codex-X | OpenAI Codex 桌面端/CLI 的可视化管理工具，具有Provider/API 切换、会话同步、提示词注入、Skills/MCP 管理、TOML 配置可视化的跨平台工具。 | [⭐ 3.7K](https://github.com/yynxxxxx/Codex-X) |
...
| ds-free-api | DeepSeek网页端API代理，支持OpenAI与Anthropic兼容接口 ｜ OpenAI & Anthropic compatible API proxy for DeepSeek web | [⭐ 738](https://github.com/NIyueeE/ds-free-api) |
...
| dstatus | DStatus 探针 是一个现代化的服务器状态监控系统，提供简洁美观的UI界面和强大的探针 agent 监控功能。 | [⭐ 414](https://github.com/fev125/dstatus) |
...
| oci-helper | 基于 Oracle OCI SDK 🐢 开发的 web 端可视化甲骨文云助手（Y探长），目前实现的功能有：批量添加多个租户配置、更改实例配置、引导卷配置、一键开启免费AMD实例下行500Mbps、一键更新、一键救援/缩小硬盘、附加ipv6、... | [⭐ 812](https://github.com/Yohann0617/oci-helper) |
...
| ContextMenuManager | 🖱️ 一个管理 Windows 右键上下文菜单的程序（支持Windows 7 - 11）A program to manage the Windows right-click context menu with support of... | [⭐ 942](https://github.com/Jack251970/ContextMenuManager) |
